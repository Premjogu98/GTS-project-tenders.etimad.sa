...
def ChromeDriver():
    ...
    while next_page_loop == True:
        for links in browser.find_elements_by_xpath('/html/body/div[9]/div/div/form/div[1]/div[3]/div[2]/div[1]/div/div/div/div[1]/div/div/div[1]/div/div[3]/h3/a'):
            for date in browser.find_elements_by_xpath('//*[@id="cardsresult"]/div[1]/div/div/div/div[1]/div/div/div[1]/div/div[1]/span'):
                ...
                if day >= 0:
                    ...
                    Collected_href.append(links.get_attribute('href'))
                else:
    ...
    for href in Collected_href:
        ...
        for d1_html_source in browser.find_elements_by_xpath('//*[@id="d-1"]'):
            ...
            for The_purpose_of_the_competition in browser.find_elements_by_xpath('//*[@id="purposeSpan"]'):
                The_purpose_of_the_competition = The_purpose_of_the_competition.get_attribute('innerText').strip().replace('...عرض الأقل...','')
        ...
        if get_htmlsource != '':
            ...
            Competition_type,Method_of_submitting_offers,A_primary_warranty_is_required,The_value_of_competition_documents,The_deadline_for_submitting_offers,Competition_case,href)
            time.sleep(3)
